...
class TextIngestor(IngestorInterface):
    """
    Text ingestor class to parse the .txt files and return a list of QuoteModel objects.
    """
    ...
    def parse(cls, path: str) -> List[Any]:
        ...
        # Text ingestor will not depend on subprocess to delete the file, can reuse the same function in pdf ingestor.
